...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    [layoutAttributesForElementsInRect enumerateObjectsUsingBlock:^(UICollectionViewLayoutAttributes *attributes, NSUInteger idx, BOOL *stop)
     {
         {
...
#pragma mark - Deleting Animation

-(void) prepareForCollectionViewUpdates:(NSArray *)updateItems
{
    [super prepareForCollectionViewUpdates:updateItems];
    
    self.removedIndexPath = [NSMutableArray array];
    ...
    [updateItems enumerateObjectsUsingBlock:^(UICollectionViewUpdateItem *updateItem, NSUInteger idx, BOOL *stop)
     {
         ...
         if ( updateItem.updateAction == UICollectionUpdateActionDelete )
         {
             ...
             [self.removedIndexPath addObject:updateItem.indexPathBeforeUpdate];
         }
     }];
}
...
- (UICollectionViewLayoutAttributes *)finalLayoutAttributesForDisappearingItemAtIndexPath:(NSIndexPath *)itemIndexPath
{
    ...
    if ( [self.removedIndexPath containsObject:itemIndexPath] )
    {
